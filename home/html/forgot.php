            ...
            <div class="auth-box row">
                <div class="col-lg-12 bg-white">
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body bg-danger text-light">
                                                <h2> Username / Email is invalid. </h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="p-3">
                        ...
                        <form action="server/forgot.php" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="formUser">Email</label>
                                        <input class="form-control" id="uname" name="formEmail" type="email"
