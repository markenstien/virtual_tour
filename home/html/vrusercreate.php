...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="background-color: #EEF5F9 !important;">
            ...
            <form action="server/vrusercreate.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="eUname" type="text" value="" required
                                                                >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="ePword" type="password" value="" required
                                                                >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="eEmail" type="email" value="" required
                                                                >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="eContact" type="tel" minlength="11" maxlength="11" value="0000" pattern="\d*" required
                                                                >
                                                        </div>
                                                    </div>
                                                </div>
