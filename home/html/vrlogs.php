            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">VR Admin Logs</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="default_order" class="table no-wrap v-middle mb-0">
                                        <thead style="background-color: #f8f9fa !important;">
                                            <tr class="border-0">
                                                <th class="border-0 font-14 font-weight-medium text-muted" style="width: 25%;">Date</th>
                                                <th class="border-0 font-14 font-weight-medium text-muted" style="width: 50%;">Log</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                // fetch
                                                $sql="select * FROM  log_tbl order by id desc"; 
                                                    ...
                                                    <tr>
                                                        <td class="border-top-0">
                                                            <div class="d-flex no-block align-items-center">
                                                                <div class="">
                                                                    <a href=""><h5 class="text-dark mb-0 font-16 font-weight-medium"> <?php echo ucwords($rowsPoi->log_date); ?> </h5></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="border-top-0">
                                                            <div class="d-flex no-block align-items-center">
                                                                <div class="">
                                                                    <a href=""><h5 class="text-dark mb-0 font-16 font-weight-medium text-mute"> <?php echo ucwords($rowsPoi->log_detail); ?> </h5></a>
                                                                </div>
                                                            </div>
                                                        </td>
