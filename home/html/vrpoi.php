            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">SPCC Virtual Tour</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <a href=""> Admin Dashboard <br>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-lg-6 align-self-center">
                            ...
                            <div class=".d-block .d-sm-block .d-md-none .d-lg-none d-xl-none text-center">
                                ...
                                <div class="customize-input">
                                    <a href="vrpoiview.php"><button type="submit" class="btn waves-effect waves-light btn-primary" name="eBUpdate"><i class="fas fa-plus"></i> &nbsp Add POI </button></a>
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">POI List</h4>
                                <h5 class="card-subtitle mb-2 text-muted"></h5>
                                <br>
                                <div class="table-responsive">
                                    <table id="default_order" class="table no-wrap v-middle mb-0">
                                        <thead style="background-color: #f8f9fa !important;">
                                            <tr class="border-0">
                                                <th class="border-0 font-14 font-weight-medium text-muted" style="width: 50%;">POI Name</th>
                                                <th class="border-0 font-14 font-weight-medium text-muted" style="width: 50%;">Menu Position</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $rsPoi=mysqli_query($connection,$sql);
                                                while ($rowsPoi = mysqli_fetch_object($rsPoi))
                                                {
                                            ?>
                                                    ...
                                                    <tr>
                                                        <td class="border-top-0">
                                                            <div class="d-flex no-block align-items-center">
                                                                <div class="">
                                                                    <a href="vrpoiview.php?id=<?php echo $rowsPoi->id; ?>"><h5 class="text-dark mb-0 font-16 font-weight-medium"> <?php echo ucwords($rowsPoi->pic_name); ?> </h5></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="border-top-0">
                                                            <div class="d-flex no-block align-items-center">
                                                                <div class="">
                                                                    <a href="vrpoiview.php?id=<?php echo $rowsPoi->id; ?>"><h5 class="text-dark mb-0 font-16 font-weight-medium"> <?php echo ucwords($rowsPoi->pic_menu_position); ?> </h5></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
