...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="background-color: #EEF5F9 !important;">
            ...
            <form action="server/vrpoicreate.php" method="POST" enctype="multipart/form-data">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Add New POI</h3>
                            <div class="d-flex align-items-center">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb m-0 p-0">
                                        <li class="breadcrumb-item"><a href="">Add New POI</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="col-lg-6 align-self-center">
                            ...
                            <div class=".d-block .d-sm-block .d-md-none .d-lg-none d-xl-none text-center">
                                ...
                                <div class="customize-input">
                                    <button type="submit" class="btn waves-effect waves-light btn-primary" name="eBUpdate"><i class="fas fa-save"></i> &nbsp Add  </button>
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="eName" type="text" value="" required
                                                                >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="uname" name="eDesc" type="number" value="1" required
                                                                >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="20" placeholder="Text Here..." name="eVScript"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="eMapX" name="eMapX" type="text" value="622" required
                                                                >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="eMapY" name="eMapY" type="text" value="364" required
                                                                >
                                                        </div>
                                                    </div>
