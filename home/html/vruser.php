                    ...
                    <div class="col-lg-6 align-self-center">
                            ...
                            <div class=".d-block .d-sm-block .d-md-none .d-lg-none d-xl-none text-center">
                                ...
                                <div class="customize-input">
                                    <a href="vrusercreate.php"><button type="submit" class="btn waves-effect waves-light btn-primary" name="eBUpdate"><i class="fas fa-plus"></i> &nbsp Add User </button></a>
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">VR Admin List</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="default_order" class="table no-wrap v-middle mb-0">
                                        <thead style="background-color: #f8f9fa !important;">
                                            <tr class="border-0">
                                                <th class="border-0 font-14 font-weight-medium text-muted" style="width: 50%;">User Name</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="border-top-0">
                                                            <div class="d-flex no-block align-items-center">
                                                                <div class="">
                                                                    <a href="vruserview.php?id=<?php echo $rowsPoi->id; ?>"><h5 class="text-dark mb-0 font-16 font-weight-medium"> <?php echo ucwords($rowsPoi->user_fname); ?> </h5></a>
                                                                </div>
                                                            </div>
                                                        </td>
