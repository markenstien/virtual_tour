...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="background-color: #EEF5F9 !important;">
            ...
            <form action="server/vruser.php?id=<?php echo $rowAccount2[0]->id; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6 align-self-center">
                            ...
                            <div class=".d-block .d-sm-block .d-md-none .d-lg-none d-xl-none text-center">
                                ...
                                <div class="customize-input">
                                    ...
                                    <button type="submit" class="btn waves-effect waves-light btn-danger" name="eBDelete" onclick="return confirm('Are you sure you want to remove this account?');"><i class="fas fa-close"></i> &nbsp Delete  </button>
                                </div>
                            </div>
